...
public class RandomWidgetProvider extends AppWidgetProvider
{
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds)
    {
        ...
        for(int widgetId : widgetIdArray)
        {
            ...
            view.setOnClickPendingIntent(R.id.text_view_random_number, pendingIntent);
            view.setTextViewText(R.id.text_view_random_number, String.valueOf(number));
